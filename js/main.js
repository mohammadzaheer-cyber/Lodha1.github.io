...
let selectoption= document.querySelectorAll('[data-dropdown-options]')
 ...
 let formTitleObj={
  ...
  'Location': "Due to huge rush at site we would request you to book your site visit in advance",
...
let btn = document.querySelectorAll('[data-open-modal]');
let close = document.querySelector('[data-close-modal]');

Array.from(btn).forEach(e => {
  e.addEventListener('click', () => {
    let formAttrValue = e.getAttribute('data-open-modal');
    formId=formAttrValue;
